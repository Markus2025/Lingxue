...
CREATE TABLE IF NOT EXISTS `cards` (
  ...
  `skills` JSON DEFAULT NULL COMMENT '技能标签 ["math1","english2"]',
  ...
  `time_slots` JSON DEFAULT NULL COMMENT '空闲时间段',
  `dimensions` JSON DEFAULT NULL COMMENT '五边形维度数据',
  `teaching_format` VARCHAR(64) DEFAULT NULL COMMENT '授课形式',
